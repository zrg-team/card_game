...
class Scene1 extends Phaser.Scene {
  ...
  async handleChooseHiddenCard() {
	...
	handleDealFirstRound(player1, player2, player3, player4) {
		...
		if (player3) {
			players[2][0] = this.add.image(600.0, 120.0, "unvisible-card").setScale(0.07, 0.07);
		}
		if (player4) {
			players[3][0] = this.add.image(110.0, 120.0, "unvisible-card").setScale(0.07, 0.07);
		}
	}
	...
	handleDealSecondRound(player1, player2, player3, player4) {
		...
		if (player3) {
			players[2][1] = this.add.image(620.0, 120.0, "unvisible-card").setScale(0.07, 0.07);
		}
		if (player4) {
			players[3][1] = this.add.image(130.0, 120.0, "unvisible-card").setScale(0.07, 0.07);
		}
	}
	...
	handleDealThirdRound(player1, player2, player3, player4) {
		...
		if (player3) {
			players[2][2] = this.add.image(640.0, 120.0, "unvisible-card").setScale(0.07, 0.07);
		}
		if (player4) {
			players[3][2] = this.add.image(150.0, 120.0, "unvisible-card").setScale(0.07, 0.07);
		}
	}
	...
	handleDealFourthRound(player1, player2, player3, player4) {
		...
		if (player3) {
			players[2][3] = this.add.image(660.0, 120.0, "unvisible-card").setScale(0.07, 0.07);
		}
		if (player4) {
			players[3][3] = this.add.image(170.0, 120.0, "unvisible-card").setScale(0.07, 0.07);
		}
	}
	...
	handleDealFifthRound(player1, player2, player3, player4) {
		...
		if (player3) {
			players[2][4] = this.add.image(680.0, 120.0, "unvisible-card").setScale(0.07, 0.07);
		}
		if (player4) {
			players[3][4] = this.add.image(190.0, 120.0, "unvisible-card").setScale(0.07, 0.07);
		}
	}
	...
	handleDealSixthRound(player1, player2, player3, player4) {
		...
		if (player3) {
			players[2][5] = this.add.image(600.0, 90.0, "unvisible-card").setScale(0.07, 0.07);
		}
		if (player4) {
			players[3][5] = this.add.image(110.0, 90.0, "unvisible-card").setScale(0.07, 0.07);
		}
	}
	...
	handleDealSeventhRound(player1, player2, player3, player4) {
		...
		if (player3) {
			players[2][6] = this.add.image(620.0, 90.0, "unvisible-card").setScale(0.07, 0.07);
		}
		if (player4) {
			players[3][6] = this.add.image(130.0, 90.0, "unvisible-card").setScale(0.07, 0.07);
		}
	}
	...
	handleDealEighthRound(player1, player2, player3, player4) {
		...
		if (player3) {
			players[2][7] = this.add.image(640.0, 90.0, "unvisible-card").setScale(0.07, 0.07);
		}
		if (player4) {
			players[3][7] = this.add.image(150.0, 90.0, "unvisible-card").setScale(0.07, 0.07);
		}
	}
	...
	handleDealNinethRound(player1, player2, player3, player4) {
		...
		if (player3) {
			players[2][8] = this.add.image(660.0, 90.0, "unvisible-card").setScale(0.07, 0.07);
		}
		if (player4) {
			players[3][8] = this.add.image(170.0, 90.0, "unvisible-card").setScale(0.07, 0.07);
		}
	}
	...
	handleDealTenthRound(player1, player2, player3, player4) {
		...
		if (player3) {
			players[2][9] = this.add.image(680.0, 90.0, "unvisible-card").setScale(0.07, 0.07);
		}
		if (player4) {
			players[3][9] = this.add.image(190.0, 90.0, "unvisible-card").setScale(0.07, 0.07);
		}
	}
	...
	handleDealEleventhRound(player1, player2, player3, player4) {
		...
		if (player3) {
			players[2][10] = this.add.image(640.0, 60.0, "unvisible-card").setScale(0.07, 0.07);
		}
		if (player4) {
			players[3][10] = this.add.image(110.0, 60.0, "unvisible-card").setScale(0.07, 0.07);
		}
	}
	...
	handleDealTwelfthRound(player1, player2, player3, player4) {
		...
		if (player3) {
			players[2][11] = this.add.image(660.0, 60.0, "unvisible-card").setScale(0.07, 0.07);
		}
		if (player4) {
			players[3][11] = this.add.image(130.0, 60.0, "unvisible-card").setScale(0.07, 0.07);
		}
	}
	...
	handleDealThirteenthRound(player1, player2, player3, player4) {
		...
		if (player3) {
			players[2][12] = this.add.image(680.0, 60.0, "unvisible-card").setScale(0.07, 0.07);
		}
		if (player4) {
			players[3][12] = this.add.image(150.0, 60.0, "unvisible-card").setScale(0.07, 0.07);
		}
  }
  ...
  async sendCardAnimation(count, i) {
    ...
    console.log(Number(hiddenCardNumber._text));
    let count = 1;
